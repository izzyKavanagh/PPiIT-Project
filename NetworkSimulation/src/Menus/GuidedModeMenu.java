...
public class GuidedModeMenu {
			...
			List<Switch> switches, List<DHCPServer> dhcpServers, List<DNSServer> dnsServers, List<WebServer> webServers) 
	{
        ...
        // STEP 6 - CREATE SECOND LAYER 2 SWITCH
        
        // STEP 7 - CREATE THIRD LAYER 2 SWITCH
        
        // STEP 8 - CONNECT THREE 2 LAYER SWITCHES TO CORE SWITCH
        
        // STEP 9 - CREATE PC0 
        
        // STEP 10 - CREATE PC1 
        
        // STEP 11 - CONNECT PC0 & PC1 TO SWITCH1
