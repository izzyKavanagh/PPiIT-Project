...
public class Layer3Switch extends Switch implements DeviceWithCLI{
	...
	/**
     * Configures an IP helper address (e.g., for DHCP relay) on a VLAN interface.
     *
     * @param vlanId        the VLAN ID on which to configure the helper
	...
	/**
     * Starts a Command Line Interface (CLI) for interactive IP helper configuration.
     */
	@Override
